...
This is an tool to create Configs more easily for the AIO
...
Download the .zip and extract it into the AIO folder
...
####  Thirdly
Create an prompt, each prompt should have atleast 3 Key Values those are: 
...
Optionally you can also assign:
...
If you want to contribute dm me on Discord
...
This project is licensed under the Apache Version 2.0 License - see the LICENSE file
